package Grm::DBIC::Maps::Result::FeatureDetailsPrimer;
...
__PACKAGE__->table("feature_details_primer");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Gp0Pk47fdjRtps18nnsC4Q
