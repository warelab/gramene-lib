use utf8;
package Grm::DBIC::Variation::Result::MotifFeatureVariation;
...
Grm::DBIC::Variation::Result::MotifFeatureVariation
...
=head1 TABLE: C<motif_feature_variation>

=cut

__PACKAGE__->table("motif_feature_variation");

=head1 ACCESSORS

=head2 motif_feature_variation_id
...
=item * L</motif_feature_variation_id>

=back

=cut

__PACKAGE__->set_primary_key("motif_feature_variation_id");


# Created by DBIx::Class::Schema::Loader v0.07036 @ 2013-12-18 14:36:00
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OPoxWskK19ceP5z93PDmaw
