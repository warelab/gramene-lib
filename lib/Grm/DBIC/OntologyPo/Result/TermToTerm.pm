package Grm::DBIC::OntologyPo::Result::TermToTerm;
...
Related object: L<Grm::DBIC::OntologyPo::Result::RelationshipType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2gqyGyZaiMRvCUTiadVH0w
