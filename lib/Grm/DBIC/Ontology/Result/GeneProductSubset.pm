package Grm::DBIC::Ontology::Result::GeneProductSubset;
...
Grm::DBIC::Ontology::Result::GeneProductSubset
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Cg0iRO9XzLM3JNgvJG9XYA
