package Grm::DBIC::Ontology::Result::GeneProductProperty;
...
Grm::DBIC::Ontology::Result::GeneProductProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SiyCuFPnLqjsFLUZNsHSbA
