package Grm::DBIC::AmigoGo::Result::RelationProperty;
...
Grm::DBIC::AmigoGo::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8VblPus/pMIAZzwXHiJAZw
