package Grm::DBIC::AmigoGo::Result::GeneProductDbxref;
...
Grm::DBIC::AmigoGo::Result::GeneProductDbxref
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gLUUawQzdewAY3w0mTlRzA
