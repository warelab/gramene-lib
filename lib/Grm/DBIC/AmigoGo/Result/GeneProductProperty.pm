package Grm::DBIC::AmigoGo::Result::GeneProductProperty;
...
Grm::DBIC::AmigoGo::Result::GeneProductProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iwFGSpwQalxkfu1Eryb22A
