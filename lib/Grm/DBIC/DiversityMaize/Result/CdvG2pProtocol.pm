package Grm::DBIC::DiversityMaize::Result::CdvG2pProtocol;
...
Grm::DBIC::DiversityMaize::Result::CdvG2pProtocol
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ukcFbQpDznEPDruEeCjRNw
