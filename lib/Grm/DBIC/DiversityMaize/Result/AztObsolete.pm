package Grm::DBIC::DiversityMaize::Result::AztObsolete;
...
Grm::DBIC::DiversityMaize::Result::AztObsolete
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JWyq2enqhZ+lcAW0so0LDA
