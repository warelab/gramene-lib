package Grm::DBIC::DiversityMaize::Result::StsSubmission;
...
Grm::DBIC::DiversityMaize::Result::StsSubmission
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5KtIqeXJiGdHf5mZCsObLA
