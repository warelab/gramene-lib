package Grm::DBIC::DiversityMaize::Result::DivTraitUom;
...
Grm::DBIC::DiversityMaize::Result::DivTraitUom
...
__PACKAGE__->add_unique_constraint("div_trait_uom_acc", ["div_trait_uom_acc"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xnCj1TJNxbr0RFhM2Hwd5g
