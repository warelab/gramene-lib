package Grm::DBIC::DiversityMaize::Result::GrmSnpAssoc;
...
Grm::DBIC::DiversityMaize::Result::GrmSnpAssoc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SMrv80kqxzuVg1aU++aAGw
