package Grm::DBIC::DiversityMaize::Result::AuxMapInfo;
...
Grm::DBIC::DiversityMaize::Result::AuxMapInfo
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ueJNKbmYRoQgKK8GTUafGg
