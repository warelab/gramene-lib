package Grm::DBIC::DiversityMaize::Result::AuxAssayPlantGenotypeAcc;
...
Grm::DBIC::DiversityMaize::Result::AuxAssayPlantGenotypeAcc

=cut

__PACKAGE__->table("aux_assay_plant_genotype_acc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+6oPFxGzMD8t8d1Vs7DVGw
