package Grm::DBIC::DiversityMaize::Result::GrmSnpAssocOntology;
...
Grm::DBIC::DiversityMaize::Result::GrmSnpAssocOntology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XesLUvXkKzAptNd1C+VuKA
