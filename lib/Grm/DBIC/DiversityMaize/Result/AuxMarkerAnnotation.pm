package Grm::DBIC::DiversityMaize::Result::AuxMarkerAnnotation;
...
Grm::DBIC::DiversityMaize::Result::AuxMarkerAnnotation
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bUCUBGLfq7gwKwGqonZqbw
