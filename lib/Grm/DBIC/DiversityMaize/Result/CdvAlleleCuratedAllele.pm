package Grm::DBIC::DiversityMaize::Result::CdvAlleleCuratedAllele;
...
Grm::DBIC::DiversityMaize::Result::CdvAlleleCuratedAllele
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nk2qwrVPPDfxTm2Q/CTPhw
