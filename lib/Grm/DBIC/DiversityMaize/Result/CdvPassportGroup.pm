package Grm::DBIC::DiversityMaize::Result::CdvPassportGroup;
...
Grm::DBIC::DiversityMaize::Result::CdvPassportGroup
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cchI6vjvw9hx+owcDy8/hg
