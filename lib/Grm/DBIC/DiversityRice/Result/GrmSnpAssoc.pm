package Grm::DBIC::DiversityRice::Result::GrmSnpAssoc;
...
Grm::DBIC::DiversityRice::Result::GrmSnpAssoc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jQTY38RepLBOWDsByrvflQ
