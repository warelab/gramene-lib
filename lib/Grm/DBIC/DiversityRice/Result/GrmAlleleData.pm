package Grm::DBIC::DiversityRice::Result::GrmAlleleData;
...
Grm::DBIC::DiversityRice::Result::GrmAlleleData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:00bzHn9/tfuaaBOJX9E+sQ
