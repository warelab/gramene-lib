package Grm::DBIC::DiversityRice::Result::CdvAlleleCuratedAllele;
...
Grm::DBIC::DiversityRice::Result::CdvAlleleCuratedAllele
...
Related object: L<Grm::DBIC::DiversityRice::Result::CdvCuratedAllele>

=cut

__PACKAGE__->belongs_to(
  "cdv_curated_allele",
  "Grm::DBIC::DiversityRice::Result::CdvCuratedAllele",
...
Related object: L<Grm::DBIC::DiversityRice::Result::CdvCuration>

=cut

__PACKAGE__->belongs_to(
  "cdv_curation",
  "Grm::DBIC::DiversityRice::Result::CdvCuration",
...
Related object: L<Grm::DBIC::DiversityRice::Result::DivAllele>

=cut

__PACKAGE__->belongs_to(
  "div_allele",
  "Grm::DBIC::DiversityRice::Result::DivAllele",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K6ecBupHHhcJ+cE5Rm+ZLQ
