package Grm::DBIC::DiversityRice::Result::CdvMarkerAnnotationType;
...
Related object: L<Grm::DBIC::DiversityRice::Result::CdvMarkerAnnotation>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HSyp1PgKTup34Se4btNr1w
