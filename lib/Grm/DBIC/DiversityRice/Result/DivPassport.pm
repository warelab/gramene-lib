package Grm::DBIC::DiversityRice::Result::DivPassport;
...
Related object: L<Grm::DBIC::DiversityRice::Result::DivTaxonomy>

=cut

__PACKAGE__->belongs_to(
  "div_taxonomy",
  "Grm::DBIC::DiversityRice::Result::DivTaxonomy",
...
Related object: L<Grm::DBIC::DiversityRice::Result::DivAccessionCollecting>
...
Related object: L<Grm::DBIC::DiversityRice::Result::CdvSource>
...
Related object: L<Grm::DBIC::DiversityRice::Result::DivSynonym>

=cut

__PACKAGE__->has_many(
  "div_synonyms",
  "Grm::DBIC::DiversityRice::Result::DivSynonym",
  { "foreign.div_passport_id" => "self.div_passport_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:T6LEkSPQ/JPJvXk77iSpzA
