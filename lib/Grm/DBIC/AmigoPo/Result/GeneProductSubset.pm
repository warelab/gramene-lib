package Grm::DBIC::AmigoPo::Result::GeneProductSubset;
...
Grm::DBIC::AmigoPo::Result::GeneProductSubset
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b6zzrxiHQU0Ko+Y6ddVcgA
