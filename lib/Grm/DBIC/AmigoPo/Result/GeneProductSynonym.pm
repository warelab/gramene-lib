package Grm::DBIC::AmigoPo::Result::GeneProductSynonym;
...
Grm::DBIC::AmigoPo::Result::GeneProductSynonym
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:e9JO/sns3lNeCugObciJKQ
