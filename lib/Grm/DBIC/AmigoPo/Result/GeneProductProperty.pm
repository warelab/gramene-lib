package Grm::DBIC::AmigoPo::Result::GeneProductProperty;
...
Grm::DBIC::AmigoPo::Result::GeneProductProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kTMimayaGdt9SRlICqLAdw
