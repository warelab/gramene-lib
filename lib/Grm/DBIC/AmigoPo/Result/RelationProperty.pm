package Grm::DBIC::AmigoPo::Result::RelationProperty;
...
Grm::DBIC::AmigoPo::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qAcK+VdkiNJIyqY24+r+9w
