package Grm::DBIC::AmigoPo::Result::Term2termMetadata;
...
Grm::DBIC::AmigoPo::Result::Term2termMetadata
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WDQKU2VwFC5ikcfgdyGQrg
