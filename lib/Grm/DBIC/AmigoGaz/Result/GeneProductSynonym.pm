package Grm::DBIC::AmigoGaz::Result::GeneProductSynonym;
...
Grm::DBIC::AmigoGaz::Result::GeneProductSynonym
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TLL+TP91xxCr7hpmu/4uPA
