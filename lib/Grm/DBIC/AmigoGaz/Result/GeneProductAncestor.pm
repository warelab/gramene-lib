package Grm::DBIC::AmigoGaz::Result::GeneProductAncestor;
...
Grm::DBIC::AmigoGaz::Result::GeneProductAncestor
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:X8A5h7ig9V0cm0BJ2pV+mA
