package Grm::DBIC::AmigoGaz::Result::GeneProductDbxref;
...
Grm::DBIC::AmigoGaz::Result::GeneProductDbxref
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ucserGIZDm/xxm8/QeZx0A
