package Grm::DBIC::AmigoGaz::Result::GeneProductHomology;
...
Grm::DBIC::AmigoGaz::Result::GeneProductHomology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:us3WPhNWnMRNaFsUoTSiPw
