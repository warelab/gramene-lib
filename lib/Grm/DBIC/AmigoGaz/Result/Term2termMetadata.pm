package Grm::DBIC::AmigoGaz::Result::Term2termMetadata;
...
Grm::DBIC::AmigoGaz::Result::Term2termMetadata
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/H3NQOYqUnXsUL/rk6vXWQ
