package Grm::DBIC::AmigoGaz::Result::RelationProperty;
...
Grm::DBIC::AmigoGaz::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lAWKvgD0z4Nlj5BIrFjJjw
