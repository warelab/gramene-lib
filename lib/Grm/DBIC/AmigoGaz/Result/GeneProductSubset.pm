package Grm::DBIC::AmigoGaz::Result::GeneProductSubset;
...
Grm::DBIC::AmigoGaz::Result::GeneProductSubset
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YaCaS9mFiy8TJX0arW7c+Q
