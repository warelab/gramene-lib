package Grm::DBIC::Diversity::Result::AuxAssayPlantGenotype;
...
Grm::DBIC::Diversity::Result::AuxAssayPlantGenotype
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ObhUifHODplAB038vlVJqw
