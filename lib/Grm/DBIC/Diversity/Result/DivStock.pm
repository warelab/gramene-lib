package Grm::DBIC::Diversity::Result::DivStock;
...
Related object: L<Grm::DBIC::Diversity::Result::DivGeneration>

=cut

__PACKAGE__->belongs_to(
  "div_generation",
  "Grm::DBIC::Diversity::Result::DivGeneration",
...
Related object: L<Grm::DBIC::Diversity::Result::DivStockParent>

=cut

__PACKAGE__->has_many(
  "div_stock_parent_div_stocks",
  "Grm::DBIC::Diversity::Result::DivStockParent",
  { "foreign.div_stock_id" => "self.div_stock_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ua82yzDAF1R9Y3kFHnj0HA
