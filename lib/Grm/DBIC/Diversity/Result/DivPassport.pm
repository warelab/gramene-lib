package Grm::DBIC::Diversity::Result::DivPassport;
...
Related object: L<Grm::DBIC::Diversity::Result::CdvPassportSet>
...
Related object: L<Grm::DBIC::Diversity::Result::DivTaxonomy>
...
Related object: L<Grm::DBIC::Diversity::Result::CdvSource>

=cut

__PACKAGE__->belongs_to(
  "cdv_source",
  "Grm::DBIC::Diversity::Result::CdvSource",
...
Related object: L<Grm::DBIC::Diversity::Result::DivStock>

=cut

__PACKAGE__->has_many(
  "div_stocks",
  "Grm::DBIC::Diversity::Result::DivStock",
  { "foreign.div_passport_id" => "self.div_passport_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Grm::DBIC::Diversity::Result::DivSynonym>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6XHRaLZUU7qmIrAYUklrcA
