package Grm::DBIC::Diversity::Result::AuxAssayPlantGenotypeCount;
...
Grm::DBIC::Diversity::Result::AuxAssayPlantGenotypeCount
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tpdPao4P1ADroh0SJJuuYQ
