package Grm::DBIC::Diversity::Result::DivTraitWinterData;
...
Grm::DBIC::Diversity::Result::DivTraitWinterData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+DyXtPJG8BC1d1zMHxUjpg
