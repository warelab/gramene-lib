package Grm::DBIC::Diversity::Result::GrmSnpGeneCache;
...
Grm::DBIC::Diversity::Result::GrmSnpGeneCache
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RUVXgDVZwrdmuJN7dzzsZw
