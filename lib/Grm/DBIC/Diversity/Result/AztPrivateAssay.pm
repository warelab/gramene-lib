package Grm::DBIC::Diversity::Result::AztPrivateAssay;
...
Grm::DBIC::Diversity::Result::AztPrivateAssay
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GMYY0IU5JjHZuZ+nMHUkhQ
