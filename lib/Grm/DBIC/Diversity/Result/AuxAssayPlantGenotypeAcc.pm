package Grm::DBIC::Diversity::Result::AuxAssayPlantGenotypeAcc;
...
Grm::DBIC::Diversity::Result::AuxAssayPlantGenotypeAcc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rr1wb6CiS1iI/rP+Zv8fIQ
