package Grm::DBIC::OntologyTax::Result::TermToTerm;
...
Related object: L<Grm::DBIC::OntologyTax::Result::RelationshipType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CNaXmES1lvPkrCQHVJ42wg
