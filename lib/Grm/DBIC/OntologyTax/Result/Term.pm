package Grm::DBIC::OntologyTax::Result::Term;
...
Related object: L<Grm::DBIC::OntologyTax::Result::Association>
...
Related object: L<Grm::DBIC::OntologyTax::Result::GraphPath>
...
Related object: L<Grm::DBIC::OntologyTax::Result::ObjectAssociationCount>

=cut

__PACKAGE__->has_many(
  "object_association_counts",
  "Grm::DBIC::OntologyTax::Result::ObjectAssociationCount",
  { "foreign.term_id" => "self.term_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Grm::DBIC::OntologyTax::Result::QuickTermToObject>

=cut

__PACKAGE__->has_many(
  "quick_terms_to_object",
  "Grm::DBIC::OntologyTax::Result::QuickTermToObject",
  { "foreign.term_id" => "self.term_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Grm::DBIC::OntologyTax::Result::TermType>
...
Related object: L<Grm::DBIC::OntologyTax::Result::TermSynonym>

=cut

__PACKAGE__->has_many(
  "term_synonyms",
  "Grm::DBIC::OntologyTax::Result::TermSynonym",
  { "foreign.term_id" => "self.term_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KP8nT6YpFj2cUSFWxpAVeA
