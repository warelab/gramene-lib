package Grm::DBIC::EnsemblCompara::Result::MethodLinkSpeciesSet;
...
Grm::DBIC::EnsemblCompara::Result::MethodLinkSpeciesSet
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BsvlxEOnPCiOkEPrarg5Ag
