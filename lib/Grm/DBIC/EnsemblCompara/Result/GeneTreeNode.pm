package Grm::DBIC::EnsemblCompara::Result::GeneTreeNode;
...
Grm::DBIC::EnsemblCompara::Result::GeneTreeNode
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tNlzZwqVZSZgB+23kb0EGg
