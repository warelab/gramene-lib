package Grm::DBIC::EnsemblCompara::Result::SequenceExonBounded;
...
Grm::DBIC::EnsemblCompara::Result::SequenceExonBounded
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NQtc/ejRbY65x3mc89Gwdg
