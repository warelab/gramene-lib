package Grm::DBIC::EnsemblCompara::Result::GeneTreeNodeAttr;
...
Grm::DBIC::EnsemblCompara::Result::GeneTreeNodeAttr
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:u2kqrHapQX1XGYb7IwJtYQ
