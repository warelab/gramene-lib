package Grm::DBIC::EnsemblCompara::Result::CafeTreeAttr;
...
Grm::DBIC::EnsemblCompara::Result::CafeTreeAttr
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UzsbHHkfXbOANEHi0HPqSg
