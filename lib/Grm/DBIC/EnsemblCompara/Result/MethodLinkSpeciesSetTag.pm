package Grm::DBIC::EnsemblCompara::Result::MethodLinkSpeciesSetTag;
...
Grm::DBIC::EnsemblCompara::Result::MethodLinkSpeciesSetTag
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RSG1HgmWmpI8xH/8j+kDpw
