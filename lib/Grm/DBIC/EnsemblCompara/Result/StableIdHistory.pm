package Grm::DBIC::EnsemblCompara::Result::StableIdHistory;
...
Grm::DBIC::EnsemblCompara::Result::StableIdHistory
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KmHDlX2rnqMWZK6le46QVw
