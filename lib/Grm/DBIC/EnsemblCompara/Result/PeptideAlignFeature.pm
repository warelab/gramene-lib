package Grm::DBIC::EnsemblCompara::Result::PeptideAlignFeature;
...
Grm::DBIC::EnsemblCompara::Result::PeptideAlignFeature

=cut

__PACKAGE__->table("peptide_align_feature");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+b5W63D9t/CI33p61KFLUQ
