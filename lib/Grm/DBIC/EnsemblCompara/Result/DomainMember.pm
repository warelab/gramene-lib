package Grm::DBIC::EnsemblCompara::Result::DomainMember;
...
Grm::DBIC::EnsemblCompara::Result::DomainMember
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CjRlWu6nZx/yMo8D6pLerA
