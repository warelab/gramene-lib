package Grm::DBIC::AmigoTax::Result::GeneProductHomology;
...
Grm::DBIC::AmigoTax::Result::GeneProductHomology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cbJfdEj3V0eVit1xPZ09NA
