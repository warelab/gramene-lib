package Grm::DBIC::AmigoTax::Result::GeneProductSynonym;
...
Grm::DBIC::AmigoTax::Result::GeneProductSynonym
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rp2rAq46JhaSmz2aTEyfJw
