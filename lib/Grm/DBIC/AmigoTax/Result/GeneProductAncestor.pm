package Grm::DBIC::AmigoTax::Result::GeneProductAncestor;
...
Grm::DBIC::AmigoTax::Result::GeneProductAncestor
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ozoHOvd6UDqVxwsVrTmVsQ
