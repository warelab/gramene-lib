package Grm::DBIC::AmigoTax::Result::Term2termMetadata;
...
Grm::DBIC::AmigoTax::Result::Term2termMetadata
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QnYcT/5jARFjyzz+K1vvEw
