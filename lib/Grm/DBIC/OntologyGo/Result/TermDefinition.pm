package Grm::DBIC::OntologyGo::Result::TermDefinition;
...
Related object: L<Grm::DBIC::OntologyGo::Result::Dbxref>

=cut

__PACKAGE__->belongs_to(
  "dbxref",
  "Grm::DBIC::OntologyGo::Result::Dbxref",
  { dbxref_id => "dbxref_id" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CopkdshzOVza08a7mewGfA
