package Grm::DBIC::OntologyEo::Result::TermToTerm;
...
Related object: L<Grm::DBIC::OntologyEo::Result::RelationshipType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iZQbxOP+BwDAtang0hEW8g
