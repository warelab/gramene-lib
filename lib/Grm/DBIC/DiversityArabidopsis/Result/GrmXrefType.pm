package Grm::DBIC::DiversityArabidopsis::Result::GrmXrefType;
...
Grm::DBIC::DiversityArabidopsis::Result::GrmXrefType
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RzGQ640zWmGDKnL/5MOvmg
