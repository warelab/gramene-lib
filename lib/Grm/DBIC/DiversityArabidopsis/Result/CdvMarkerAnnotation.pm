package Grm::DBIC::DiversityArabidopsis::Result::CdvMarkerAnnotation;
...
Related object: L<Grm::DBIC::DiversityArabidopsis::Result::CdvMarkerAnnotationType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RXB/QX7kV3Ys36jsP0+6FQ
