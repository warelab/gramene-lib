package Grm::DBIC::DiversityArabidopsis::Result::CdvPassportSet;
...
Related object: L<Grm::DBIC::DiversityArabidopsis::Result::CdvPassportGroup>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:min95Q2smOEHDLMmHToS5w
