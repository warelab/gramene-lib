package Grm::DBIC::DiversityArabidopsis::Result::GrmAlleleData;
...
Grm::DBIC::DiversityArabidopsis::Result::GrmAlleleData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ovliTSomuvs8lVuIufk55w
