package Grm::DBIC::DiversityArabidopsis::Result::GrmSnpAssoc;
...
Grm::DBIC::DiversityArabidopsis::Result::GrmSnpAssoc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TAmJoeldTaKWzxAErmfUFQ
