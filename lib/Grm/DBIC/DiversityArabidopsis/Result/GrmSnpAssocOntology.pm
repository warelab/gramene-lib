package Grm::DBIC::DiversityArabidopsis::Result::GrmSnpAssocOntology;
...
Grm::DBIC::DiversityArabidopsis::Result::GrmSnpAssocOntology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZbLABsGtpOdzwy8byCFYsA
