package Grm::DBIC::DiversityArabidopsis::Result::DivAnnotationType;
...
Grm::DBIC::DiversityArabidopsis::Result::DivAnnotationType
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yKY+Bfbj5EPBMjkHUM2/lQ
