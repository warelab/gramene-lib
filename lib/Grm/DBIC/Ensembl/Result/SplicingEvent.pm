...
__PACKAGE__->has_many(
  ...
  { "foreign.splicing_event_id" => "self.splicing_event_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);

=head2 splicing_transcript_pairs
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wycZliedUvsUyMPzAt8WBg
