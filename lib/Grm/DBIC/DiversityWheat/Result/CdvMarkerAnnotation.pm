package Grm::DBIC::DiversityWheat::Result::CdvMarkerAnnotation;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::CdvMarkerAnnotationType>

=cut

__PACKAGE__->belongs_to(
  "cdv_marker_annotation_type",
  "Grm::DBIC::DiversityWheat::Result::CdvMarkerAnnotationType",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LB81BkEROYLclqB9hzkg1w
