package Grm::DBIC::DiversityWheat::Result::DivSampstat;
...
Grm::DBIC::DiversityWheat::Result::DivSampstat
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gXQUDTbXcBgxOf47Fp9cvQ
