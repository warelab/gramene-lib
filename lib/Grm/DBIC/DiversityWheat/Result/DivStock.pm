package Grm::DBIC::DiversityWheat::Result::DivStock;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivGeneration>
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivStockParent>

=cut

__PACKAGE__->has_many(
  "div_stock_parent_div_stocks",
  "Grm::DBIC::DiversityWheat::Result::DivStockParent",
  { "foreign.div_stock_id" => "self.div_stock_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b+NoXn0IRliLZi+VvXH+rQ
