package Grm::DBIC::DiversityWheat::Result::CdvMapFeatureAnnotation;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::CdvMapFeatureAnnotationType>

=cut

__PACKAGE__->belongs_to(
  "cdv_map_feature_annotation_type",
  "Grm::DBIC::DiversityWheat::Result::CdvMapFeatureAnnotationType",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7IjE3NW89ykqZ5vwHaF+Gg
