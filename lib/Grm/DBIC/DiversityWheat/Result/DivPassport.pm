package Grm::DBIC::DiversityWheat::Result::DivPassport;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivTaxonomy>

=cut

__PACKAGE__->belongs_to(
  "div_taxonomy",
  "Grm::DBIC::DiversityWheat::Result::DivTaxonomy",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivAccessionCollecting>
...
Related object: L<Grm::DBIC::DiversityWheat::Result::CdvSource>

=cut

__PACKAGE__->belongs_to(
  "cdv_source",
  "Grm::DBIC::DiversityWheat::Result::CdvSource",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivSynonym>

=cut

__PACKAGE__->has_many(
  "div_synonyms",
  "Grm::DBIC::DiversityWheat::Result::DivSynonym",
  { "foreign.div_passport_id" => "self.div_passport_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OQj7smAyhZBRDy3/wbImSg
