package Grm::DBIC::DiversityWheat::Result::DivAlleleAssay;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivAaAnnotation>

=cut

__PACKAGE__->has_many(
  "div_aa_annotations",
  "Grm::DBIC::DiversityWheat::Result::DivAaAnnotation",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivAllele>

=cut

__PACKAGE__->has_many(
  "div_alleles",
  "Grm::DBIC::DiversityWheat::Result::DivAllele",
  { "foreign.div_allele_assay_id" => "self.div_allele_assay_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivScoringTechType>

=cut

__PACKAGE__->belongs_to(
  "div_scoring_tech_type",
  "Grm::DBIC::DiversityWheat::Result::DivScoringTechType",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivPolyType>

=cut

__PACKAGE__->belongs_to(
  "div_poly_type",
  "Grm::DBIC::DiversityWheat::Result::DivPolyType",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:s+ZHbez5u27I4J0LEumJaQ
