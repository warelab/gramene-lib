package Grm::DBIC::DiversityWheat::Result::DivTraitUom;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivUnitOfMeasure>

=cut

__PACKAGE__->belongs_to(
  "div_unit_of_measure",
  "Grm::DBIC::DiversityWheat::Result::DivUnitOfMeasure",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Hz6Z0e/j9gg2thb0+Wollw
