package Grm::DBIC::DiversityWheat::Result::CdvPassportSet;
...
Related object: L<Grm::DBIC::DiversityWheat::Result::CdvPassportGroup>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TFGeYkUvLLRzllNwaDjDog
