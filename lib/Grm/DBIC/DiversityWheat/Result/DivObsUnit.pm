package Grm::DBIC::DiversityWheat::Result::DivObsUnit;
...
Grm::DBIC::DiversityWheat::Result::DivObsUnit
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivExperiment>

=cut

__PACKAGE__->belongs_to(
  "div_experiment",
  "Grm::DBIC::DiversityWheat::Result::DivExperiment",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivObsUnitSample>

=cut

__PACKAGE__->has_many(
  "div_obs_unit_samples",
  "Grm::DBIC::DiversityWheat::Result::DivObsUnitSample",
...
Related object: L<Grm::DBIC::DiversityWheat::Result::DivTrait>

=cut

__PACKAGE__->has_many(
  "div_traits",
  "Grm::DBIC::DiversityWheat::Result::DivTrait",
  { "foreign.div_obs_unit_id" => "self.div_obs_unit_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NLAm23DV4TYM+YzFbspw4w
