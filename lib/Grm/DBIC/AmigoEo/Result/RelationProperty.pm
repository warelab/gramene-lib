package Grm::DBIC::AmigoEo::Result::RelationProperty;
...
Grm::DBIC::AmigoEo::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Kbntd7eUmraB/tWYVuyIKg
