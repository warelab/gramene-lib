package Grm::DBIC::AmigoEo::Result::GeneProductAncestor;
...
Grm::DBIC::AmigoEo::Result::GeneProductAncestor
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AsPSBN02uKxyMB6YsbBwbw
