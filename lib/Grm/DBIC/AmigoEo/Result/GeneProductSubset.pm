package Grm::DBIC::AmigoEo::Result::GeneProductSubset;
...
Grm::DBIC::AmigoEo::Result::GeneProductSubset
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6FgbPcX7ePXMAMZ+U1vlYA
