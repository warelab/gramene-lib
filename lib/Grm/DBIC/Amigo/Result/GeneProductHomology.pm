package Grm::DBIC::Amigo::Result::GeneProductHomology;
...
Grm::DBIC::Amigo::Result::GeneProductHomology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:B3+FLHSKMwynL92yfJtZLA
