package Grm::DBIC::AmigoTo::Result::GeneProductDbxref;
...
Grm::DBIC::AmigoTo::Result::GeneProductDbxref
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EGubR7NnDsLUtZHjHhb2Fw
