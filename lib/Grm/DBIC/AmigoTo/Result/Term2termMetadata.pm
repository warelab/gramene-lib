package Grm::DBIC::AmigoTo::Result::Term2termMetadata;
...
Grm::DBIC::AmigoTo::Result::Term2termMetadata
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:umP7ghzqlWlsbEED7Tp4LA
