package Grm::DBIC::AmigoTo::Result::GeneProductHomology;
...
Grm::DBIC::AmigoTo::Result::GeneProductHomology
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SkKKToVt60XvRlIR62yF+w
