package Grm::DBIC::AmigoTo::Result::RelationProperty;
...
Grm::DBIC::AmigoTo::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bmxMraanNZ2Kmk8FixCsFA
