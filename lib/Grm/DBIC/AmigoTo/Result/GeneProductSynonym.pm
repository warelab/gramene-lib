package Grm::DBIC::AmigoTo::Result::GeneProductSynonym;
...
Grm::DBIC::AmigoTo::Result::GeneProductSynonym
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NPs6t2pGdKJslm6s9e4NRw
