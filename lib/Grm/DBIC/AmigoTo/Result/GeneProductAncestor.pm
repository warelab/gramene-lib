package Grm::DBIC::AmigoTo::Result::GeneProductAncestor;
...
Grm::DBIC::AmigoTo::Result::GeneProductAncestor
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HT3MPScSBEDU2+6dY0ylPw
