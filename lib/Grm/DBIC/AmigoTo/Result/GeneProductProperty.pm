package Grm::DBIC::AmigoTo::Result::GeneProductProperty;
...
Grm::DBIC::AmigoTo::Result::GeneProductProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QY7pou++NkMVrUZcf5eTzg
