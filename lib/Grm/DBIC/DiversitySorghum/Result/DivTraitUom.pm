package Grm::DBIC::DiversitySorghum::Result::DivTraitUom;
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivUnitOfMeasure>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H17nSa18PxgUlJINknM6Ag
