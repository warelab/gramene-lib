package Grm::DBIC::DiversitySorghum::Result::DivObsUnit;
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivExperiment>

=cut

__PACKAGE__->belongs_to(
  "div_experiment",
  "Grm::DBIC::DiversitySorghum::Result::DivExperiment",
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivLocality>

=cut

__PACKAGE__->belongs_to(
  "div_locality",
  "Grm::DBIC::DiversitySorghum::Result::DivLocality",
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivTrait>

=cut

__PACKAGE__->has_many(
  "div_traits",
  "Grm::DBIC::DiversitySorghum::Result::DivTrait",
  { "foreign.div_obs_unit_id" => "self.div_obs_unit_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QZZsOOyy+wVxVX4fCM+LBw
