package Grm::DBIC::DiversitySorghum::Result::CdvMapFeatureAnnotation;
...
Grm::DBIC::DiversitySorghum::Result::CdvMapFeatureAnnotation
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::CdvMapFeature>

=cut

__PACKAGE__->belongs_to(
  "cdv_map_feature",
  "Grm::DBIC::DiversitySorghum::Result::CdvMapFeature",
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::CdvMapFeatureAnnotationType>

=cut

__PACKAGE__->belongs_to(
  "cdv_map_feature_annotation_type",
  "Grm::DBIC::DiversitySorghum::Result::CdvMapFeatureAnnotationType",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OzX9SJN/5FINoZqok2HTVA
