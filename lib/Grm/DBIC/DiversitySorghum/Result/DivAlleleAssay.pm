package Grm::DBIC::DiversitySorghum::Result::DivAlleleAssay;
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivAaAnnotation>
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivScoringTechType>

=cut

__PACKAGE__->belongs_to(
  "div_scoring_tech_type",
  "Grm::DBIC::DiversitySorghum::Result::DivScoringTechType",
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivPolyType>

=cut

__PACKAGE__->belongs_to(
  "div_poly_type",
  "Grm::DBIC::DiversitySorghum::Result::DivPolyType",
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::CdvMarker>

=cut

__PACKAGE__->belongs_to(
  "cdv_marker",
  "Grm::DBIC::DiversitySorghum::Result::CdvMarker",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kkdlmjok0o+TB+I2NoUv1A
