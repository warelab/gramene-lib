package Grm::DBIC::DiversitySorghum::Result::CdvPassportSet;
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::CdvPassportGroup>

=cut

__PACKAGE__->belongs_to(
  "cdv_passport_group",
  "Grm::DBIC::DiversitySorghum::Result::CdvPassportGroup",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C3vI8rBkHnQ2LwAhK0ib7w
