package Grm::DBIC::DiversitySorghum::Result::GrmAlleleData;
...
Grm::DBIC::DiversitySorghum::Result::GrmAlleleData
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:w30cxO0OhDxNssvuNjudyQ
