package Grm::DBIC::DiversitySorghum::Result::DivTrait;
...
Related object: L<Grm::DBIC::DiversitySorghum::Result::DivStatisticType>

=cut

__PACKAGE__->belongs_to(
  "div_statistic_type",
  "Grm::DBIC::DiversitySorghum::Result::DivStatisticType",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QBG7cIB44OL+WEJL6STyXA
