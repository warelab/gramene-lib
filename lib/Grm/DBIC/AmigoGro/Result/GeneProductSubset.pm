package Grm::DBIC::AmigoGro::Result::GeneProductSubset;
...
Grm::DBIC::AmigoGro::Result::GeneProductSubset
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oZYOw7qgba2gM0GBJNu4kw
