package Grm::DBIC::AmigoGro::Result::RelationProperty;
...
Grm::DBIC::AmigoGro::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GsxbU1dNKVXTXcYl96Axeg
