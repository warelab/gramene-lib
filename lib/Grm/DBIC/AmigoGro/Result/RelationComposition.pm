package Grm::DBIC::AmigoGro::Result::RelationComposition;
...
Grm::DBIC::AmigoGro::Result::RelationComposition
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RfDLBZkS/yjT8gGqu+TNTw
