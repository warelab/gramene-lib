package Grm::DBIC::AmigoGro::Result::GeneProductAncestor;
...
Grm::DBIC::AmigoGro::Result::GeneProductAncestor
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hHUxjN1HdjiRlhlx8/5oaA
