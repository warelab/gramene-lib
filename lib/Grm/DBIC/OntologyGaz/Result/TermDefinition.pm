package Grm::DBIC::OntologyGaz::Result::TermDefinition;
...
Related object: L<Grm::DBIC::OntologyGaz::Result::Dbxref>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IBmx5vzLAYgrLm9kKldvYQ
