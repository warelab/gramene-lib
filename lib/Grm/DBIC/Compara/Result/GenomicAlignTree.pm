package Grm::DBIC::Compara::Result::GenomicAlignTree;
...
Grm::DBIC::Compara::Result::GenomicAlignTree
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AvAsvGLu7fRghX8odN26kg
