package Grm::DBIC::Compara::Result::GenomicAlignBlock;
...
Grm::DBIC::Compara::Result::GenomicAlignBlock
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WwvYYSQ28ZsdU2ABFeXRwA
