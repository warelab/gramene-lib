package Grm::DBIC::Maps::Result::FeatureDetailsCentromere;
...
__PACKAGE__->table("feature_details_centromere");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Zm/dsYPpVZVtSi7+sObeXg
