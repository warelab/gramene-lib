package Grm::DBIC::Maps::Result::FeatureDetailsEstCluster;
...
__PACKAGE__->table("feature_details_est_cluster");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XGZKJ6f5p4mufwPdS5YZDA
