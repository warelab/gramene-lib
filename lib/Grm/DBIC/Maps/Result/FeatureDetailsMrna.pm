package Grm::DBIC::Maps::Result::FeatureDetailsMrna;
...
__PACKAGE__->table("feature_details_mrna");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qZvRKKlAubdkthodRbqfbg
