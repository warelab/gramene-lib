package Grm::DBIC::Maps::Result::FeatureDetailsSscp;
...
__PACKAGE__->table("feature_details_sscp");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ujHK8PZ3ErMUnDZFdS7jfw
