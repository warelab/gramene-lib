package Grm::DBIC::GrameneAmigoOntology::Result::Term2term;
...
Grm::DBIC::GrameneAmigoOntology::Result::Term2term
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OtKDpRPmC/34vmiffOU6tA
