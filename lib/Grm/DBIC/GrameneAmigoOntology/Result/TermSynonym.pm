package Grm::DBIC::GrameneAmigoOntology::Result::TermSynonym;
...
Grm::DBIC::GrameneAmigoOntology::Result::TermSynonym
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YwczQ+7XQ5DaxcWlRi9Agg
