package Grm::DBIC::GrameneAmigoOntology::Result::RelationProperty;
...
Grm::DBIC::GrameneAmigoOntology::Result::RelationProperty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZcdwwzRxdVWhGE7ICmlKQA
