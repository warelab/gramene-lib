package Grm::DBIC::OntologyGro::Result::TermDefinition;
...
Related object: L<Grm::DBIC::OntologyGro::Result::Dbxref>

=cut

__PACKAGE__->belongs_to(
  "dbxref",
  "Grm::DBIC::OntologyGro::Result::Dbxref",
  { dbxref_id => "dbxref_id" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PAsNm6Gt7NzcQova/cjf8Q
